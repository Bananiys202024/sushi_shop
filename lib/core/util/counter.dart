        ...
        children: [
          new SizedBox(
            ...
            child: FloatingActionButton(
              heroTag: "decremention_button_" + heroTag,
              onPressed: _decrementCounter,
              elevation: 2,
              tooltip: 'Decrement',
              child: Icon(Icons.remove, size: this.buttonSize),
          ...
          new SizedBox(
            ...
            height: buttonSize,
            child: FloatingActionButton(
              heroTag: "incremention_button_" + heroTag,
              onPressed: _incrementCounter,
              elevation: 2,
              tooltip: 'Increment',
              child: Icon(Icons.add, size: this.buttonSize),
              backgroundColor: color,
            ),
          ),
        ],
