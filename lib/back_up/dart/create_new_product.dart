...
class _CreateNewProductState extends State<CreateNewProduct> {
  ...
  Future uploadFile()  async {
    ...
    debugPrint("Image from uploadFile from create_new_product:__"+_image.toString());
...
//
//      try {
//        debugPrint("try___"+storageReference.path.toString());
//        debugPrint("DownloadURL___"+storageReference.getDownloadURL().toString());
//
//
//
//        storageReference.getDownloadURL().then((fileURL) {
//          setState(() {
//            debugPrint("form inside of uploadFile in flutter app");
//            _uploadedFileURL = fileURL;
//            debugPrint('value setted of uploaded file url--' +
      ...
      child: RaisedButton(
        onPressed: () async {
          if (_formKey.currentState.validate()) {
            ...
            List<String> list_of_search_keywords = await create_search_key_words_list(name_field_controller.text);
            debugPrint('URL--'+_uploadedFileURL.toString());
            debugPrint("List---"+list_of_search_keywords.toString());
